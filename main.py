...
model.match(all_d, all_d)
model.group(link_min_similarity=0.68)
model.get_matches()
...
for every cluster sort the list by length

search through all elements in df
-if an element is part of a cluster, replace it with it with the simplest form
